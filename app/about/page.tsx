  ...
  return (
    <div className="min-h-screen bg-green-50 -mx-6 -my-8 md:-mx-8 md:-my-12 px-6 py-8 md:px-8 md:py-12">
      <article className="prose prose-lg max-w-none">
        ...
        <p>
          I am also the Head of Products &amp; Innovation at{" "}
          <a href="https://www.flowretail.no" target="_blank" rel="noopener noreferrer">
            Flow Solutions
          </a>
          , where we build a tech-savvy top modern commerce platform for entrepreneurs. I am also the Chief Solution
          Architect in the e-commerce division, and also the Chairman of the Board, aaand the largest investor in the
          company.
        </p>
        <p>
          And yea, I am also a co-founder and mostly CTO in other startups, like Bippr, where we work to get especially
          children off the digital highway and back out into the physical world.
        </p>
        <p>
          I also do lots of advisory, both directly 1:1, to teams and through advisory boards, from just being a proud
          member, to actually leading boards.
        </p>
        <p>
          Other startups I am involved in is{" "}
          <a href="https://insp.no/" target="_blank" rel="noopener noreferrer">
            Insp
          </a>
          , where we work with several things, among them to use social media "in a better way", to help smaller
          retailers and more.
        </p>
        <p>
